...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="contact-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1.4fr", gap:"3.5rem", alignItems:"start" }}>
          ...
          <div>
            {[
              ...
              <div key={label} style={{ display:"flex", gap:"0.9rem", marginBottom:"1.7rem", alignItems:"flex-start" }}>
                <div style={{ width:46, height:46, borderRadius:13, background:"#FDF3DC", display:"flex", alignItems:"center", justifyContent:"center", fontSize:"1.25rem", flexShrink:0 }}>{icon}</div>
                <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, background:"#25D366", color:"white", padding:"0.88rem 1.8rem", borderRadius:100, fontSize:"0.9rem", fontWeight:700, marginBottom:"1.5rem", transition:"background 0.25s" }}
        ...
        <FadeIn delay={140}>
          <div style={{ background:"white", borderRadius:24, padding:"2.3rem", boxShadow:"0 10px 40px rgba(93,58,26,0.07)" }}>
            ...
            <button
              ...
              style={{ width:"100%", background:"#5D3A1A", color:"white", padding:"0.95rem", border:"none", borderRadius:100, fontSize:"0.93rem", fontWeight:700, cursor:"pointer", transition:"all 0.3s" }}
              onMouseEnter={e => { e.currentTarget.style.background="#E8A020"; e.currentTarget.style.color="#3D1F00"; }}
              onMouseLeave={e => { e.currentTarget.style.background="#5D3A1A"; e.currentTarget.style.color="white"; }}
            >🌿 Send Message</button>
          </div>
        </FadeIn>
      </div>
